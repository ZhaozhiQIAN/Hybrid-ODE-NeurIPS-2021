...
def run(
    ...
    model_ml = init_and_load(
        dg, encoder_output_dim, encoder_latent_ratio, ode_step_div, "gruode", ode_method, init_path, t0
    )
    ...
    eval_dict = {"x": x, "x_hat": x_hat, "mask": mask, "name": "ensemble", "model_path": None}
